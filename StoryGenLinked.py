...
# Date: 16/09/2025
# Description: Code for prompting LLaMA to generate a seven paragraph story with an event outline and phoneme incorporation.
...
# the mapping file is the output file from event extraction and conversion, the mistakes file is the output file of Mistakes.py 
# containing the five error phonemes to incorporate and the output file can be what you want.
OUTLINE_FILE = ""
SOURCE_FILE = ""
MAPPING_FILE = ""
MISTAKES_FILE = ""
...
# Method for locating a story number.
...
def generate_continuation_paragraph(
    ...
    # transition, event and phonemes to incorporate as well as the previous and current source paragraphs and the last paragraph generated
    # by the model.
    prompt_body = f"""
...
def build_story(
    ...
    for i in range(1, len(outline)):
        ...
        new_paragraph = generate_continuation_paragraph(
            theme=theme,
            phonemes = load_mistakes("phonemes.txt"),
