...
output_file1 = 'filtered_stories_150_AFP.txt' # Output of Aesop for Children stories with fewer than 150 words
input_file2 = 'Glot_cleaned_stories.txt' # Input of GlotStoryBook
output_file2 = 'filtered_stories_150_Glot.txt' # Output of GlotStoryBook stories with fewer than 150 words
