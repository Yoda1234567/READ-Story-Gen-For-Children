...
output_file1 = 'filtered_stories_800_AFP.txt' # Output of Aesop for Children stories with more than 800 words
input_file2 = 'Glot_cleaned_stories.txt' # Input of GlotStoryBook
output_file2 = 'filtered_stories_800_Glot.txt' # Output of GlotStoryBook stories with more than 800 words
